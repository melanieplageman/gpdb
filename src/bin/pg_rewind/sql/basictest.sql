...
PGOPTIONS=${PGOPTIONS_UTILITY} $STANDBY_PSQL -c "SET enable_seqscan=off; SELECT * from tbl2 WHERE d LIKE '%something'"
}
...
PGOPTIONS=${PGOPTIONS_UTILITY} $MASTER_PSQL -c "SET enable_seqscan=off; SELECT * from tbl2 WHERE d LIKE '%something'"
}
