...
{
	CMappingVarColId *var_col_id_map_copy = var_col_id_mapping->CopyMapColId(m_mp);
	...
	)
{
	...
	CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarSubquery(m_mp, col_id));
